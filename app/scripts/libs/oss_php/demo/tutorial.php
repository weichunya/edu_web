...
function upload_by_file($obj){
	$bucket = 'hitaopic';
	$object = 'b/index_banner.jpg';	
	$file_path = "/home/work/hitao_hot/gate/public/static/images/banner/index_banner.jpg";
...
function upload_by_multi_part($obj){
	$bucket = 'hitaopic';
	$object = 'a/icon-'.time().'.jpg';  //英文
	$filepath = "/home/work/hitao_hot/gate/public/static/images/icon/pic_desc.jpg";  //英文
